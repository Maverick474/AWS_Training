...
const server2 = http.createServer((req, res)=>{
    ...
    if (url==='/message' && method === 'POST') {
        ...
        req.on('end', ()=>{
            ...
            //Notice we have used sync instead of create file function because it will only execute
            //Other lines of code when this line (55) is completed
            fs.writeFileSync('message.txt', message) // a messagetxt file will be created and a dummy text will be inserted
            res.statusCode = 302;
